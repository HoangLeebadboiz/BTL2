...
def evaluate_square(small_board):
    ...
    if small_board[0][2] + small_board[1][1] + small_board[2][0] == -2:
        res -= 6
    # block moves is even greater
    for i in range(3):
        if small_board[i][0] + small_board[i][1] + small_board[i][2] == -1 and small_board[i][0] != 0 and small_board[i][1] != 0 and small_board[i][2] != 0:
            res += 10
        if small_board[0][i] + small_board[1][i] + small_board[2][i] == -1 and small_board[0][i] != 0 and small_board[1][i] != 0 and small_board[2][i] != 0:
            res += 10
        if small_board[i][0] + small_board[i][1] + small_board[i][2] == 1 and small_board[i][0] != 0 and small_board[i][1] != 0 and small_board[i][2] != 0:
            res -= 10
        if small_board[0][i] + small_board[1][i] + small_board[2][i] == 1 and small_board[0][i] != 0 and small_board[1][i] != 0 and small_board[2][i] != 0:
            res -= 10
    # because 2 in a diagonal have more priority, res should be greater
    if small_board[0][0] + small_board[1][1] + small_board[2][2] == -1 and small_board[0][0] != 0 and small_board[1][1] != 0 and small_board[2][2] != 0:
        res += 12
    if small_board[0][2] + small_board[1][1] + small_board[2][0] == -1 and small_board[2][0] != 0 and small_board[1][1] != 0 and small_board[0][2] != 0:
        res += 12
    if small_board[0][0] + small_board[1][1] + small_board[2][2] == 1 and small_board[0][0] != 0 and small_board[1][1] != 0 and small_board[2][2] != 0:
        res -= 12
    if small_board[0][2] + small_board[1][1] + small_board[2][0] == 1 and small_board[2][0] != 0 and small_board[1][1] != 0 and small_board[0][2] != 0:
    ...
    if depth == 0:
        if ini % 2 == 0:
            ...
            if len(valid_moves) == 0:
                return evaluate_whole(cur_state)
...
def select_move(cur_state, remain_time):
    ...
    if len(valid_moves) == 0:
        return None
    chosen = select_move_util(cur_state, remain_time, 2, 2)[0]
